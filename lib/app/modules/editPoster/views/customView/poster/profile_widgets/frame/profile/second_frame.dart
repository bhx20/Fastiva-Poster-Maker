...
class SecondFrameView extends GetView<EditPosterController> {
  final Rx<FrameSettings> data;
  const SecondFrameView({super.key, required this.data});
          ...
          return Positioned(
            ...
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Center(
                  child: PosterContent(
                      data: data, profileFrame: ProfileFrame.second),
                ),
              ),
            ),
          );
